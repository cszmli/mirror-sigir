...
class MirrorModel(nn.Module):
    ...
    def decode_beam(self, tgt, context_x, dec_state_cxz2y, lengths, ctx_cat=True):
        if ctx_cat:
            out_cxz2y, dec_state_cxz2y, attns_cxz2y = self.decoder_cxz2y(tgt, context_x, dec_state_cxz2y)
        else:
            out_cxz2y, dec_state_cxz2y, attns_cxz2y = self.decoder_cxz2y(tgt, context_x, dec_state_cxz2y, context_lengths=lengths)
